...
class CrawlInvestingBitcoinNews extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'crawl:investingBitcoinNews {pages=1 : 采集的页码数}';
     ...
     * @var string
     */
    protected $description = '爬取英为财经比特币新闻';
    ...
    public function handle()
    {
        ...
        $bar->finish();
        file_put_contents(base_path('public') .'/bitcoin_'. time() . '.json', json_encode($articels));
    }
    ...
    protected function performList($page)
    {
        ...
        $data = $ql->get('https://cn.investing.com/crypto/bitcoin/news/' . $page, null, [
            'headers' => [
